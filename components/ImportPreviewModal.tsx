...
const styles = StyleSheet.create({
  ...
  title: { color: '#fff', fontSize: 22, fontWeight: '900', letterSpacing: -0.5, fontFamily: 'ZalandoBold' },
  ...
  badgeText: { color: '#60a5fa', fontSize: 11, fontWeight: '900', letterSpacing: 0.5, fontFamily: 'ZalandoBold' },
  productTitle: { color: '#fff', fontSize: 20, fontWeight: '800', lineHeight: 24, fontFamily: 'ZalandoBold' },
  price: { color: '#60a5fa', fontSize: 22, fontWeight: '900', marginTop: 6, letterSpacing: -0.5, fontFamily: 'ZalandoBold' },
  section: { marginBottom: 24 },
  label: { color: '#52525b', fontSize: 11, fontWeight: '900', letterSpacing: 1.5, marginBottom: 12, fontFamily: 'ZalandoBold' },
  ...
  qtyText: { color: '#fff', fontSize: 20, fontWeight: '900', width: 35, textAlign: 'center', fontFamily: 'ZalandoBold' },
  textArea: { backgroundColor: '#18181b', color: '#fff', padding: 18, borderRadius: 18, minHeight: 120, textAlignVertical: 'top', fontSize: 16, fontFamily: 'ZalandoRegular' },
