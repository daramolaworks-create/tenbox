...
const DEALS = [
  ...
  },
  {
    ...
    title: "Flash Sale",
    subtitle: "From $2.99",
    url: "https://www.shein.com/flash-sale.html",
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <Text style={styles.subtitle}>
        Import products from anywhere in the world
      </Text>
...
const StoreCard: React.FC<{
  ...
  onOpenBrowser: ShopViewProps["onOpenBrowser"];
}> = ({ store: s, onOpenBrowser }) => {
