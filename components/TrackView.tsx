          ...
          <Card style={styles.resultCard}>
            ...
            <View style={styles.statusHeader}>
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      getStatusColor(trackingResult.status) + "20",
                  },
                ]}
              >
            ...
            <View style={styles.infoRow}>
              ...
              <View style={styles.infoItem}>
                ...
                <Text style={styles.infoValue}>
                  {trackingResult.carrier?.toUpperCase()}
                </Text>
              </View>
            </View>
                  ...
                  <View key={i} style={styles.timelineItem}>
                    <View
                      style={[
                        ...
                        {
                          borderColor:
                            i === 0 ? getStatusColor(event.status) : "#E5E5EA",
                        },
                      ]}
                    >
                      {i === 0 && (
                ...
                <Card style={styles.shipmentCard}>
                  ...
                  <View style={styles.shipmentBody}>
                    ...
                    <Text style={styles.shipmentRoute}>
                      {s.origin} <ChevronRight size={14} color="#8E8E93" />{" "}
                      {s.destination}
                    </Text>
                  </View>
                </Card>
            ...
            <View style={styles.tipsBanner}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.tipsText}>
                  Enter your tracking number from any carrier to get real-time
                  updates
                </Text>
              </View>
            </View>
