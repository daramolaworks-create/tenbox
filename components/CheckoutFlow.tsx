...
const styles = StyleSheet.create({
    ...
    headerTitle: { fontSize: 17, fontWeight: '700', fontFamily: 'ZalandoBold' },
    ...
    stepTitle: { fontSize: 28, fontWeight: '800', marginHorizontal: 24, marginTop: 16, marginBottom: 8, letterSpacing: -0.5, fontFamily: 'ZalandoBold' },
    ...
    addrLabel: { fontSize: 16, fontWeight: '700', marginBottom: 4, fontFamily: 'ZalandoBold' },
    addrText: { fontSize: 14, color: '#3A3A3C', lineHeight: 20, fontFamily: 'ZalandoRegular' },
    defaultTag: { fontSize: 11, fontWeight: '700', color: '#0223E6', backgroundColor: '#E0E7FF', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, overflow: 'hidden', fontFamily: 'ZalandoBold' },
    ...
    // Review
    sectionHeader: { fontSize: 12, fontWeight: '700', color: '#8E8E93', letterSpacing: 1, marginBottom: 12, fontFamily: 'ZalandoBold' },
    ...
    reviewMainText: { fontSize: 15, fontWeight: '600', color: '#000', fontFamily: 'ZalandoBold' },
    reviewSubText: { fontSize: 13, color: '#8E8E93', marginTop: 2, fontFamily: 'ZalandoRegular' },
    ...
    paymentText: { fontSize: 15, fontWeight: '600', color: '#000', fontFamily: 'ZalandoBold' },

    summaryCard: { padding: 20, backgroundColor: '#fff' },
    sumRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 12 },
    sumLabel: { fontSize: 15, color: '#8E8E93', fontFamily: 'ZalandoMedium' },
    sumVal: { fontSize: 15, fontWeight: '500', color: '#000', fontFamily: 'ZalandoMedium' },
    ...
    sumTotalLabel: { fontSize: 17, fontWeight: '700', color: '#000', fontFamily: 'ZalandoBold' },
    sumTotalVal: { fontSize: 24, fontWeight: '800', color: '#0223E6', fontFamily: 'ZalandoBold' },
